...
import Link from '@docusaurus/Link'; // Add this import at the top
...
export default function Home() {
  return (
    <Layout
      ...
      description="Ananta Cloud provides a comprehensive library of pre-built modules, tools, and frameworks.">
      ...
      <main className="container margin-vert--lg">
        <div className="row">
          <div className="col col--4">
            <Link to="/docs/devops-foundations"  className="card shadow--md padding--lg" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          <div className="col col--4">
            <Link to="/docs/getting-started/Createaccount"  className="card shadow--md padding--lg" style={{ textDecoration: 'none', color:             'inherit' }}>
      ...
      <main className="container margin-vert--lg">
        <div className="row" style={{ display: 'flex', justifyContent: 'center' }}>
          <div className="col col--4">
            <a href="https://terragrunt.gruntwork.io/" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="card shadow--md padding--lg">
              <h3 className={styles.cardTitle}>Terragrunt</h3>
              <p className={styles.cardText}>
          ...
          <div className="col col--4">
            <a href="https://terratest.gruntwork.io/" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="card shadow--md padding--lg">
              <h3 className={styles.cardTitle}>Terratest</h3>
              <p className={styles.cardText}>
