      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p>
              {showModal === 'subscription'
                ? `This link points to the private terraform-aws-autoscaling-module repository, which is accessible only to subscribers. Non-subscribers will receive a 404 error.`
            ...
            >
              ...
              <a
                href={
                  showModal === 'subscription'
                    ? 'https://github.com/anantacloud/terraform-aws-autoscaling-module.git'
                    : 'https://github.com/anantacloud/terraform-aws-autoscaling-module/releases'
                }
                target="_blank"
