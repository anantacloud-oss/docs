      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p>
              {showModal === 'subscription'
                ? `This link points to the private terraform-aws-kubernetes-module repository, which is accessible only to subscribers. Non-subscribers will receive a 404 error.`
            ...
            >
              ...
              <a
                href={
                  showModal === 'subscription'
                    ? 'https://github.com/anantacloud/terraform-aws-kubernetes-module.git'
                    : 'https://github.com/anantacloud/terraform-aws-kubernetes-module/releases'
                }
                target="_blank"
