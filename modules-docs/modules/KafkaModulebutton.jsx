      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p>
              {showModal === 'subscription'
                ? `This link points to the private terraform-aws-kafka-module repository, which is accessible only to subscribers. Non-subscribers will receive a 404 error.`
