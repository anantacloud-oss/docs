      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p>
              {showModal === 'subscription'
                ? `This link points to the private terraform-aws-rds-module repository, which is accessible only to subscribers. Non-subscribers will receive a 404 error.`
            ...
            >
              ...
              <a
                href={
                  showModal === 'subscription'
                    ? 'https://github.com/anantacloud/terraform-aws-rds-module.git'
                    : 'https://github.com/anantacloud/terraform-aws-rds-module/releases'
                }
                target="_blank"
